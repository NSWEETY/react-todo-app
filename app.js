...
var Todo = function (_React$Component) {
  ...
  _createClass(Todo, [{
    ...
    value: function handleSubmit(event) {
      console.log("this is where submit happen ");
    }
  }, {
    key: "render",
...
var TodoList = function (_React$Component2) {
  ...
  function TodoList(props) {
    ...
    _this2.state = {
      todos: [{ _id: 'a', text: 'Item 1', done: false }, { _id: 'b', text: 'Item 2', done: false }, { _id: 'c', text: 'Item 3', done: false }, { _id: 'd', text: 'Item 4', done: false }]
    };
